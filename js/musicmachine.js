$(document).ready(function () {
    ...
    var recordedNotes = [];
    var ohmyDarlinClem = ["C,4", "C,4", "C,4", "G,3", "E,4", "E,4", "E,4", "C,4", "C,4", "E,4", "G,4", "G,4", "F,4",
    "E,4", "D,4", "D,4", "E,4", "F,4", "F,4", "E,4", "D,4", "E,4", "C,4", "C,4", "E,4", "D,4", "G,3", "B,3", "D,4", "C,4"];
    var TenThousandCattle = ["C,4", "D,4", "C,4", "F,4", "F,4", "D,4", "C,4", "F,4", "G,4", "F,4", "E,4", "E,4", "D,4", "C,4", "F,4", "C,4",
        "D,4", "C,4", "F,4", "F,4", "D,4", "C,4", "F,4", "G,4", "F,4", "E,4", "E,4", "D,4", "D,4", "C,4", "F,4"];
    // This anonymous function makes the Play Recording
    // button play the array of recorded notes
    $("#songTwoButton").click(function () {
        $("#SongTitle").text("\"Ten Thousand Cattle\"");
        playRecording(TenThousandCattle);


    });
    $("#songOneButton").click(function () {
        $("#SongTitle").text("\"Oh My Darlin' Clementine\"");
        playRecording(ohmyDarlinClem);
